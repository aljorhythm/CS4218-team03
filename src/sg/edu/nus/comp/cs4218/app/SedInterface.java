...
public interface SedInterface extends Application {
     ...
     * @throws Exception
     */
    String replaceSubstringInFile(String regexp, String replacement, int replacementIndex,
     ...
     * @throws Exception
     */
    String replaceSubstringInStdin(String regexp, String replacement, int replacementIndex,
