...
public final class CommandBuilder {
    ...
    public static Command parseCommand(String commandString, ApplicationRunner appRunner)
        ...
        while (!commandSubstring.isEmpty()) {
            ...
            commandSubstring = commandSubstring.substring(matcher.start());
            ...
            switch (firstChar) {
                ...
                case CHAR_PIPE:
                    if (tokens.isEmpty()) {
                        ...
                        callCmdsForPipe.add(new CallCommand(Arrays.asList(args), appRunner));
                    }
                    tokens.clear();
                    break;
                ...
                case CHAR_SEMICOLON:
                    if (tokens.isEmpty()) {
                        ...
                        Command newCC = new CallCommand((LinkedList) ((LinkedList) tokens).clone(), appRunner);
                        cmdsForSequence.add(newCC);
